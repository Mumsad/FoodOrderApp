...
import com.example.foodorder.PayoutActivity
...
class CartFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        /*val cartFoodName = listOf("Burger", "Sandwich", "Momo", "Herbal Pancake", "Mixing", "Burger")
        ...
        val adapter = CartAdapter(requireContext(), ArrayList(cartFoodName), ArrayList(cartPrice), ArrayList(foodImages))
...
//
//        val cartFoodName =
//            listOf("Burger", "Sandwich", "momo", "Herbal Pancake", "Mixing",)
//        val cartPrice = listOf("$10", "$8", "$15", "$99", "$50", "$12")
//        val foodImages = listOf(
//            R.drawable.menu1,
//            R.drawable.menu2,
